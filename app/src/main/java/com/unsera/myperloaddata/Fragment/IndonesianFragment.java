 ...
 */
public class IndonesianFragment extends Fragment implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_indonesian, container, false);
    ...
    public boolean onQueryTextChange(String newText) {
        if(newText.equals("")){
            ...
            ArrayList<KamusModel> kamusModels = kamusHelper.getDataByName(newText);
